...
set_output_delay -clock {CLKLO}  0 [get_ports {RESOUT_N}]
set_input_delay  -clock {CLKLO} 10 [get_ports {GPIO0[*] GPIO1[*] GPIO2[*]}]
set_output_delay -clock {CLKLO} 10 [get_ports {GPIO0[*] GPIO1[*] GPIO2[*]}]
set_input_delay  -clock {CLKLO} 10 [get_ports {RXD}]
set_output_delay -clock {CLKLO} 10 [get_ports {TXD}]
set_input_delay  -clock {CLKLO} 10 [get_ports {I2C0_SCL I2C0_SDA I2C0_INT1 I2C0_INT2}]
set_output_delay -clock {CLKLO} 10 [get_ports {I2C0_SCL I2C0_SDA}]
set_input_delay  -clock {CLKLO} 10 [get_ports {I2C1_SCL I2C1_SDA}]
set_output_delay -clock {CLKLO} 10 [get_ports {I2C1_SCL I2C1_SDA}]
set_input_delay  -clock {CLKLO} 10 [get_ports {SPI_MISO}]
set_output_delay -clock {CLKLO} 10 [get_ports {SPI_CSN[*] SPI_SCK SPI_MOSI}]
set_input_delay  -clock {CLKLO} 20 [get_ports {SDRAM_DQ[*]}]
set_output_delay -clock {CLKLO} 20 [get_ports {SDRAM_DQ[*] SDRAM_ADDR[*]}]
set_output_delay -clock {CLKLO} 20 [get_ports {SDRAM_CSn SDRAM_RASn SDRAM_CASn SDRAM_WEn}]
set_output_delay -clock {CLKLO} 20 [get_ports {SDRAM_CKE SDRAM_BA[*] SDRAM_DQM[*]}]
set_output_delay -clock {CLKLO} 10 [get_ports {SDRAM_CLK}]
...
create_clock -name TCKo  -period 100.000 [get_nets  {U_CHIP_TOP|U_CJTAG_2_JTAG|TCK}]
...
set_input_delay  -clock {TCKo }  5 [get_ports {TRSTn TMS TDI}]
set_output_delay -clock {TCKi }  5 [get_ports {TDO}]
set_output_delay -clock {TCKo }  5 [get_ports {TDO}]
...
set_input_delay  -clock {CLK  }  5 [get_ports {RES_N}]
set_input_delay  -clock {CLK  }  5 [get_ports {STBY_REQ  }]
set_output_delay -clock {CLK  }  5 [get_ports {STBY_ACK_N}]
set_input_delay  -clock {CLKLO}  5 [get_ports {TCKC_rep}]
set_input_delay  -clock {CLKLO}  5 [get_ports {TMSC_rep}]
set_output_delay -clock {CLKLO}  5 [get_ports {TMSC_rep}]
set_output_delay -clock {CLKLO}  5 [get_ports {TMSC_PUP_rep}]
set_output_delay -clock {CLKLO}  5 [get_ports {TMSC_PDN_rep}]
set_input_delay  -clock {CLKLO}  5 [get_ports {RES_N}]
set_input_delay  -clock {CLKLO}  5 [get_ports {STBY_REQ  }]
set_output_delay -clock {CLKLO}  5 [get_ports {STBY_ACK_N}]

create_clock -name TCKC  -period 100.000 [get_ports {TCKC_rep  }]
...
set_input_delay  -clock {TCKC }  5 [get_ports {TMSC_rep}]
set_output_delay -clock {TCKC }  5 [get_ports {TMSC_rep}]
set_input_delay  -clock {TMSC }  5 [get_ports {TCKC_rep}]
set_output_delay -clock {TMSC }  5 [get_ports {TCKC_rep}]
